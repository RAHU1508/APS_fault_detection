...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_validation_dir = os.path.join(training_pipeline_config.artifact_dir , "data_validation") #data_validation folder will get created in each of the timestamps directory
        self.report_file_path=os.path.join(self.data_validation_dir, "report.yaml")  #report is needed to be created in the artifact directory
